...
import '../screens/pages/ServiceProviderPages/ServiceProviderDrawer/_service_provider_landing_page.dart';
...
class NotificationServices {
  ...
  void handleMessage(BuildContext context, RemoteMessage message) {
      ...
      Navigator.push(context,
          MaterialPageRoute(builder: (context) => ServiceProviderLandingPage(0
          )));
