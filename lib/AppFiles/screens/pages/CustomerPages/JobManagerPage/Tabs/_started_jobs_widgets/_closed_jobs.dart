...
class ItemCustomerClosedJobs extends StatelessWidget {
  ResponseCustomersShowJobs job;
  late JobApplicant? _jobApplicant;
  ResponseLoginUser responseLoginUser;
  ItemCustomerClosedJobs(this.job, this.responseLoginUser);
  @override
                          ...
                          Container(
                            ...
                            child: GestureDetector(
                              onTap: () {
                                ...
                                //     builder: (context) =>
                                //         CustomerJobDetail(job.id.toString(), false)));
                              },
                              child: RichText(
                                text: TextSpan(
                                  children: [
  ...
  String manageStatus(
    ...
    print("CurrentClosedJobStatus$status");
