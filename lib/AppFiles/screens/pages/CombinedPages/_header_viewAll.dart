...
class HeaderViewAll extends StatefulWidget {
  @override
  State<HeaderViewAll> createState() => _HeaderViewAllState();
}

class _HeaderViewAllState extends State<HeaderViewAll> {
...
//get user origin
  ...
  _showBottomSheetAdvanceSearch(BuildContext context) {
