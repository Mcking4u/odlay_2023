...
SpTopRatedServiceProviders spTopRatedServiceProvidersFromJson(String str) =>
    SpTopRatedServiceProviders.fromJson(json.decode(str));

String spTopRatedServiceProvidersToJson(SpTopRatedServiceProviders data) =>
    json.encode(data.toJson());

class SpTopRatedServiceProviders {
  SpTopRatedServiceProviders({
  ...
  factory SpTopRatedServiceProviders.fromJson(Map<String, dynamic> json) =>
      SpTopRatedServiceProviders(
